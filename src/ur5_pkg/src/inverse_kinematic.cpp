...
Matrix86ld computeInverseKinematics(Vector3ld p60, Matrix3ld r60)
{
    ...
    long double theta_1_1, theta_1_2;
    {
        ...
        theta_1_1 = phi_1 + phi_2 + PIMEZZI; //forse da aggiungere la funzione real() di mathlab
    ...
    theta_5_2 = - acos( (p60(0)*sin(theta_1_1) - p60(1)*cos(theta_1_1) - Di[3] ) / Di[5]);
    theta_5_3 = acos( (p60(0)*sin(theta_1_2) - p60(1)*cos(theta_1_2) - Di[3] ) / Di[5]);
    theta_5_4 = - acos( (p60(0)*sin(theta_1_2) - p60(1)*cos(theta_1_2) - Di[3] ) / Di[5]);

    //Trovo theta 6
    long double theta_6_1, theta_6_2, theta_6_3, theta_6_4;
    {
        Matrix4ld t06 = t60.inverse(); 
        Vector3ld xHat {t06(0, 0), t06(1, 0), t06(2, 0)}; // da controllare
        Vector3ld yHat {t06(0, 1), t06(1, 1), t06(2, 1)}; // da controllare
    ...
    long double p41xz_1 = hypot(p41_1.first, p41_1.third);
    ...
    long double p41xz_2 = hypot(p41_2.first, p41_2.third);
    ...
    long double p41xz_3 = hypot(p41_3.first, p41_3.third);
    ...
    long double p41xz_4 = hypot(p41_4.first, p41_4.third);
    ...
    theta_2_1 = atan2(-p41_1.third, -p41_1.first) - asin((-Ai[2] * sin(theta_3_1) ) / p41xz_1);
    theta_2_2 = atan2(-p41_2.third, -p41_2.first) - asin((-Ai[2] * sin(theta_3_2) ) / p41xz_2);
    theta_2_3 = atan2(-p41_3.third, -p41_3.first) - asin((-Ai[2] * sin(theta_3_3) ) / p41xz_3);
    theta_2_4 = atan2(-p41_4.third, -p41_4.first) - asin((-Ai[2] * sin(theta_3_4) ) / p41xz_4);
    theta_2_5 = atan2(-p41_1.third, -p41_1.first) - asin(( Ai[2] * sin(theta_3_1) ) / p41xz_1);
    theta_2_6 = atan2(-p41_2.third, -p41_2.first) - asin(( Ai[2] * sin(theta_3_2) ) / p41xz_2);
    theta_2_7 = atan2(-p41_3.third, -p41_3.first) - asin(( Ai[2] * sin(theta_3_3) ) / p41xz_3);
    theta_2_8 = atan2(-p41_4.third, -p41_4.first) - asin(( Ai[2] * sin(theta_3_4) ) / p41xz_4);
