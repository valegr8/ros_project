...
class ForwardKinematicRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ForwardKinematicRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ForwardKinematicRequest
    let len;
    let data = new ForwardKinematicRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ForwardKinematicRequest(null);
...
class ForwardKinematicResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.x = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ForwardKinematicResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ForwardKinematicResponse
    let len;
    let data = new ForwardKinematicResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ur5_pkg/ForwardKinematicResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ForwardKinematicResponse(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
module.exports = {
  Request: ForwardKinematicRequest,
  Response: ForwardKinematicResponse,
  md5sum() { return '1d89c8f7ccd238d24ca1c2a794f9dbfe'; },
  datatype() { return 'ur5_pkg/ForwardKinematic'; }
};
